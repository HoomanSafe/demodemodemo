  ...
  const utilities = [
    {
      ...
      description: 'Use VIRTU tokens to access premium AI analytics tools and advanced trading features'
    },
    {
      icon: Coins,
      title: 'Stake for Rewards',
      description: 'Earn passive income by staking your VIRTU tokens in the platform'
    },
    {
      icon: Users,
      title: 'Governance Rights',
      description: 'Participate in platform governance and shape the future of VIRTU'
    }
  ]
    ...
    <section className="w-full py-16">
      <div className="text-center mb-12 animate-fade-in">
        ...
        <p className="mt-4 text-lg text-green-300">
          The VIRTU token powers our ecosystem and provides valuable benefits to holders
        </p>
      </div>
        ...
        {utilities.map((utility, index) => (
          ...
          >
            <Card className="bg-[#1a1a2e]/80 backdrop-blur-sm border-green-500/20 p-6 text-white hover:border-green-500/40 transition-all duration-300 hover-scale">
              ...
              <p className="text-green-300/80 text-sm">{utility.description}</p>
            </Card>
          </div>
        ))}
      </div>
